...
const Mega = () => {
  ...
  return (
    ...
    <div className='my-8'>
      ...
      <h1 className='text-4xl font-bold leading-tight text-center my-8'>Discover the Blogs World</h1>
